...
public class NeuralNetworkTest {
    ...
    @Test
    public void testOneHiddenLayerHighLearningRateLowEpochs() {
        //neural network settings
        double learningRate = 0.003;
        long epochs = 2_000;
        List<Integer> layerSettings = new ArrayList<>(Arrays.asList(2, 6, 1));
    ...
    @Test
    public void testOneHiddenLayerHighLearningRateHighEpochs() {
        //neural network settings
        double learningRate = 0.003;
        long epochs = 10_000_000;
        List<Integer> layerSettings = new ArrayList<>(Arrays.asList(2, 6, 1));
        Network network = new Network(layerSettings);
        network.setSparseActivation(false);
        network.setLearningRate(learningRate);
    ...
    @Test
    public void testOneHiddenLayerHighLearningRate() {
        //neural network settings
        double learningRate = 0.003;
        long epochs = 2_000_000;
        List<Integer> layerSettings = new ArrayList<>(Arrays.asList(2, 6, 1));
